...
## Grunt-init
These templates are generated by the grunt plugin: [grunt-init](https://github.com/gruntjs/grunt-init). "Grunt-init is scaffolding tool to automate project creation." Grunt-init is a dependency for these templates to be installed.
